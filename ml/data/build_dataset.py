...
CUAD_JSON_PATH = Path("CUAD_v1.json")
OUTPUT_PATH = Path("clean_sentence_dataset.csv")

# Replace with your exact labels you want
SELECTED_LABELS = {
    "Governing Law",
...
# Ignore this and use the actual sentence splitter you built
